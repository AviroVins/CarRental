                            ...
                            <button
                                ...
                                @if(Auth::user()->profile_photo)
                                    <img src="{{ asset('storage/profile_photos/' . Auth::user()->profile_photo) }}"
                                         alt="Profile photo"
                                         class="rounded-full object-cover w-8 h-8 mr-2">
                                @else
                                    <!-- fallback icon (e.g. generic user icon) -->
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @else
                <div class="px-4 space-y-1">
                    <a href="{{ route('login') }}"
                       class="block text-sm text-gray-700 dark:text-gray-300 underline hover:text-gray-900 dark:hover:text-white">
                        Logowanie
                    </a>
